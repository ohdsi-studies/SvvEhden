...
#' @export
runCohortDiagnostics_mod <- function(packageName = NULL,
  ...
  cohortTableColumnNamesExpected <-
    getResultsDataModelSpecifications_mod() %>%
  ...
  # Counting cohorts -----------------------------------------------------------------------
  cohortCounts <- computeCohortCounts_mod(connection,
                                      cohortDatabaseSchema,
                                      cohortTable,
                                      cohortDefinitionSet,
                                      exportFolder,
...
executeDiagnosticsOutsidePackage <- function(cohortDefinitionSet,
  ...
  runCohortDiagnostics_mod(packageName = "OutsidePackage",
                       cohortDefinitionSet = cohortDefinitionSet,
                       exportFolder = exportFolder,
                       databaseId = databaseId,
                       connectionDetails = connectionDetails,
