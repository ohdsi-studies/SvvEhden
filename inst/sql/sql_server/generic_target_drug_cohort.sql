...
--       see cohort-id 1778577 for example butalbital cohort (concept-id: 1139699)
/* 
##################################################################################
*/
...
select event_id, person_id, 
  case when DATEADD(day,@fixed_TAR,start_date) > op_end_date then op_end_date else DATEADD(day,@fixed_TAR,start_date) end as end_date
INTO #strategy_ends
